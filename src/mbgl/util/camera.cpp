...
Camera::Camera() : orientation(Quaternion::identity), flippedY(false), pixelsPerMeter(1.0) {
...
void Camera::setPosition(const LatLng& position, double pixelElevation, double zoom) {
